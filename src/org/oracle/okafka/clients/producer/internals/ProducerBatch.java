...
public final class ProducerBatch {
	 ...
	 * @return true if the batch was completed successfully and false if the batch was previously aborted
	 */
	public boolean done(long baseOffset, long logAppendTime,  List<String> msgIds, RuntimeException exception) {
		final FinalState tryFinalState = (exception == null) ? FinalState.SUCCEEDED : FinalState.FAILED;
	...
	private void completeFutureAndFireCallbacks(long baseOffset, long logAppendTime, List<String> msgIds, RuntimeException exception) {
		// Set the future before invoking the callbacks as we rely on its state for the `onCompletion` call
